      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1] mb-6">
            <span className="text-white">J&apos;imagine,</span>{" "}
            <span className="text-white">développe</span>{" "}
        ...
        >
          <a
            href="#platforms"
            className="px-6 py-3 text-sm font-medium text-white bg-blue-600 hover:bg-blue-500 rounded-full transition-colors"
          >
            Explorer le laboratoire
          </a>
          <a
            href="#contact"
            className="px-6 py-3 text-sm font-medium text-gray-300 border border-white/10 hover:border-white/30 rounded-full transition-colors"
          >
            Démarrer un projet
          </a>
        </motion.div>
